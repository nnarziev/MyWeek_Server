...
from pybrain3 import SharedFullConnection, MotherConnection, MDLSTMLayer, IdentityConnection
from pybrain3 import ModuleMesh, LinearLayer, TanhLayer, SigmoidLayer
from pybrain3.structure.networks import BorderSwipingNetwork
