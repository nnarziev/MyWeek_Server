...
from pybrain3.structure.moduleslice import ModuleSlice
from pybrain3.structure.connections.identity import IdentityConnection
from pybrain3.structure.networks.feedforward import FeedForwardNetwork
from pybrain3.structure.connections.shared import MotherConnection, SharedFullConnection
from pybrain3.structure.modules.biasunit import BiasUnit
from pybrain3.utilities import crossproduct
from pybrain3.structure.networks.convolutional import SimpleConvolutionalNetwork
