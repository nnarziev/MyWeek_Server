...
from pybrain3.rl.environments.twoplayergames.capturegameplayers import ModuleDecidingPlayer
...
from pybrain3.structure.networks.custom.capturegame import CaptureGameNetwork
