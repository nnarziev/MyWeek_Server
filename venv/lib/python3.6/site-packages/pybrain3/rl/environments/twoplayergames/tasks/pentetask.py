...
from pybrain3.rl.environments.twoplayergames.pente import PenteGame
from pybrain3.rl.environments.episodic import EpisodicTask
from .gomokutask import GomokuTask
from pybrain3.rl.environments.twoplayergames.gomokuplayers import RandomGomokuPlayer
